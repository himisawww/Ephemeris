...
int_t Precompute_Table_size(int_t n){
...
#else
fast_mpvec sum_2(const fast_mpvec &r,const fast_mpvec *cn){
...
fast_mpvec sum_3(const fast_mpvec &r,const fast_mpvec *cn){
...
fast_mpvec sum_4(const fast_mpvec &r,const fast_mpvec *cn){
...
fast_mpvec sum_5(const fast_mpvec &r,const fast_mpvec *cn){
...
fast_mpvec sum_6(const fast_mpvec &r,const fast_mpvec *cn){
...
fast_mpvec sum_7(const fast_mpvec &r,const fast_mpvec *cn){
...
fast_mpvec sum_8(const fast_mpvec &r,const fast_mpvec *cn){
...
fast_mpvec sum_J2(const fast_mpvec &r,const fast_mpvec *cn){
...
fast_mpvec sum_J3(const fast_mpvec &r,const fast_mpvec *cn){
...
fast_mpvec sum_J4(const fast_mpvec &r,const fast_mpvec *cn){
...
fast_mpvec sum_J5(const fast_mpvec &r,const fast_mpvec *cn){
...
fast_mpvec sum_J6(const fast_mpvec &r,const fast_mpvec *cn){
...
fast_mpvec sum_J7(const fast_mpvec &r,const fast_mpvec *cn){
...
fast_mpvec sum_J8(const fast_mpvec &r,const fast_mpvec *cn){
...
fast_mpvec geopotential::sum(fast_real R,fast_mpvec r,int_t N_start,int_t N_end) const{
